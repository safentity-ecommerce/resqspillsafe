...
export const metadata: Metadata = {
  title: "Oil Spill Kits | Resq Spill Safe",
  description:
    "Prepare for Oil Spills with our Comprehensive Kits. Explore our range of oil absorbent spill kits.",
}

export default function OilPage() {
  const products = PRODUCTS.oil
      ...
      <div className="container">
        <div className="bg-white pt-[10rem] text-text-primary">
          <div className="flex flex-col mx-auto text-center max-w-[70rem] mb-[5rem]">
            <h4 className="text-[2.2rem] font-rubik font-medium">Oil Spill Kits</h4>
